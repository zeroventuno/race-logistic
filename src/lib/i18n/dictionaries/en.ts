...
export const en: Dictionary = {
   ...
   */
  report: {
    kicker: "Final race report",
    generated: "Document generated on {quando} from the convoy's position record.",
    windowSection: "The race window",
    maxObserved: "widest observed",
    noLimit: "No limit was declared in the race setup.",
    over: "Above the {min} min limit agreed with the traffic authority.",
    within: "Within the {min} min limit agreed with the traffic authority.",
    measuredIn: "Measured across {pct} of the race from the two reference vehicles passing the same point on the road. The remainder is estimated or could not be established, and is marked as such throughout the document.",
    cannotMeasure: "Could not be measured",
    noDataAtAll: "There was not enough data to establish the window for this race.",
    summaryTitle: "1 · Summary",
    windowPair: "The lead ↔ sweep window",
    authorized: "authorised",
    notDeclared: "not declared",
    minLabel: "narrowest",
    avgLabel: "average",
    maxLabel: "widest",
    onlyMeasured: "Narrowest, average and widest consider only the instants actually measured — {medidos} of {total} points in the series. Estimated values do not enter statistics the document asserts.",
    rescue: "Rescue",
    incidents: "incidents",
    medianArrive: "median time to arrive",
    unresolved: "not closed",
    convoy: "Convoy",
    vehicles: "vehicles",
    avgSignal: "average signal coverage",
    route: "route",
    period: "Period",
    periodLine: "Start {inicio} · finish {fim}",
    timezone: " · timezone {fuso}",
    tailWarning: "Note: the convoy stopped transmitting {tempo} before the recorded finish. The period above is the one declared in the system, not the time there was racing on the road.",
    chartTitle: "2 · The window, minute by minute",
    howToRead: "How to read this",
    legMeasured: "Measured — {n} points. Difference in time between the two vehicles passing the same point on the road.",
    legDeduced: "Deduced — {n} points. Estimated from speed, or based on a position that was already stale. It was not observed.",
    legNoLine: "No line — {n} points. There was no reliable position for both vehicles. The gap is declared, not hidden.",
    legOvershoot: "Red band — stretch where the window exceeded what was authorised.",
    axes: "Vertical axis in minutes of window; horizontal, local race time. The series is rebuilt from the position record stored on the server.",
    chartCannot: "The window could not be established",
    blocksTitle: "3 · Blocking points",
    blocksNone: "No blocking points were registered for this race. Without them the report cannot state how long each junction stayed closed.",
    colKm: "km",
    colPoint: "point",
    colClosed: "closed",
    colReopened: "reopened",
    colDuration: "duration",
    blocksLead: "\"Closed\" is the lead car passing that kilometre; \"reopened\", the sweep car. Each point s duration is the window measured there. What follows the sweep car — support motorbikes, mechanics, ambulances and the broom wagon — already travels with the road open to traffic.",
    blocksMissing: "not established",
    blocksNoSweep: "The sweep car did not transmit a position, so the reopening column is empty.",
    incidentsTitle: "4 · Incidents",
    incidentsNone: "No rescue call was recorded in this race.",
    called: "called {hora}",
    calledBy: "by {quem}",
    handledBy: "handled by {quem}",
    acknowledged: "acknowledged {hora}",
    dispatched: "dispatched {hora}",
    onScene: "on scene {hora}",
    closed: "closed {hora}",
    noEvents: "no events recorded after the call",
    toArrive: "to arrive: {valor}",
    toClose: "to close: {valor}",
    notRecorded: "not recorded",
    notClosed: "not closed",
    convoyTitle: "5 · The convoy",
    colVehicle: "vehicle",
    colDriver: "driver",
    colPlate: "plate",
    colSignal: "signal",
    ...
    isSweep: " · sweep",
    never: "never",
    outages: "Signal outages longer than two minutes",
  },
  ...
  blockpoints: {
    ...
    detectedNone: "No new junctions were found on OpenStreetMap for this route.",
    detectAgain: "Detect again",
    empty: "No points registered yet.",
    noRoute: "Register the route first: points are placed by kilometre along it.",
    add: "Add point",
    km: "km",
    name: "Name",
    namePlaceholder: "Via Roma × SP 422 roundabout",
    unnamed: "unnamed",
    detectedTag: "detected",
    active: "Count in the report",
    remove: "Remove",
    saving: "saving",
    outOfRoute: "Outside the route, which is {km} km.",
    partial: "Swept up to km {ate} of {total}. Tap again to continue.",
    swept: "Whole route swept.",
  },
};
