...
export const en: Dictionary = {
  ...
  report: {
    ...
    blocksLead: "\"Closed\" is the lead car passing that kilometre. \"Reopened\" is the last vehicle of the convoy passing — the broom wagon, not the sweep car: there is still racing behind the sweep car.",
    blocksMissing: "not established",
    blocksNoSweep: "No convoy position could serve as the last vehicle, so the reopening column is empty.",
