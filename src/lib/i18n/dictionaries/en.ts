...
export const en: Dictionary = {
  ...
  alerts: {
    ...
    why: {
      target: "{position}",
      eta: "~{minutes} min",
      uncertainAnchor: "POSITION UNCERTAIN: the anchor on the course was picked by a tie-break — confirm on the radio before relying on this distance",
      ahead: "{distance} ahead of the alert (has to turn back)",
      behind: "{distance} behind the alert, travelling the same way as the race",
      straightOnly: "{distance} in a straight line — no position on the course, the road distance is greater",
      speedMeasured: "measured average speed {speed} km/h",
      speedNominal: "time estimated from nominal speed ({speed} km/h): no recent movement measured",
      lastSeen: "last position {seconds} s ago",
      offSpecialty: "{role} is not the speciality for {category} — suggested on proximity",
      noOrigin: "No origin position for the alert: no suggestion can be computed.",
      noneSuggested: "No support suggested.",
      noneDispatchable: "No dispatchable vehicle registered for this race.",
      count: "{count} suggestion(s) for {category}.",
      uncertainCount: "{count} candidate(s) with an ambiguous anchor — distance not reliable.",
      ignoredBusy: "{count} already dispatched to another alert.",
      ignoredNoSignal: "{count} ignored for lost signal.",
      ignoredRole: "{count} not dispatchable.",
      escalated: "ESCALATED: no vehicle of the right speciality available; dispatched {role}.",
      allStraight: "All in a straight line: no position on the course to compare.",
      takenMeanwhile: "Every candidate was taken by other alerts during dispatch.",
      manual: "{position} — dispatched by hand from race control.",
    },
    dispatch: {
  ...
  auth: {
    ...
    recoverSubtitle: "Enter the account's email. If it exists, we send a link to set a new password.",
    recoverSubmit: "Send link",
    recoverSent: "If an account exists for {email}, the link is on its way. It works once and expires.",
    metaRecover: "Recover access — Flamme Rouge",
    newPasswordTitle: "New password",
    newPasswordSubtitle: "Choose the password you will use to sign in to the panel.",
    newPasswordSubmit: "Save password",
    passwordChanged: "Password changed.",
    recoverExpired: "This link is no longer valid. Request another from «Forgot your password?».",
    metaNewPassword: "New password — Flamme Rouge",
    ...
    confirmed: "Done. Your account is active and you are already signed in.",
    confirmFailed: "We could not confirm the account. The email link works once and expires — sign up again with the same address to get a new one.",
    name: "Your name",
  ...
  landing: {
    ...
    measures: {
      ...
      diagramAria: "Diagram of an out-and-back course. The crash is on the outward leg; the motorbike is on the return leg, 50 metres away in a straight line but 37.3 kilometres away along the road. The ambulance is 1.5 kilometres behind the crash, on the same leg and travelling the same way.",
      diagramMoto: "**0.05 km** in a straight line between the motorbike and the crash. This is the number a geometric proximity system uses — and by it the motorbike would be the one sent.",
      diagramRoute: "**37.3 km** along the road, at the same moment: the motorbike is on the return leg and would have to drive the whole loop back against the race.",
      diagramAmb: "**1.5 km** behind, on the same leg and travelling the same way: the ambulance, which is the one the system dispatched.",
      diagramNote: "Diagram not to scale. Numbers measured on a real test course.",
    ...
    contact: {
      ...
      body: "Tell us what race you organise and what you need to solve. The person who wrote the system answers, in your language.",
      name: "Your name",
      email: "Email",
      organization: "Organisation",
      message: "Message",
      messagePlaceholder: "What race you organise, how many support vehicles, and when it is.",
      send: "Send",
      sending: "Sending…",
      sentTitle: "Received.",
      sentBody: "I will reply to the address you left, in the language you wrote in.",
      orWrite: "Or write straight to",
      failed: "It could not be sent right now. Your message is still there — copy it and send it to",
      tooMany: "Too many messages from here in a short time. Wait a little, or write to",
      nameRequired: "Give your name — it is how the reply will start.",
      emailRequired: "I need an email address to reply to.",
      emailInvalid: "That email does not look valid. Check the @ and the domain.",
      messageRequired: "Write what you need, even if it is one line.",
