...
export const fr: Dictionary = {
  ...
  report: {
    ...
    colReopened: "rouvert",
    colDuration: "durée",
    blocksLead: "« Fermé » est le passage de la voiture ouvreuse à ce kilomètre. « Rouvert » est le passage du dernier véhicule du convoi — la voiture-balai, et non la voiture de fermeture : il y a encore de la course derrière celle-ci.",
    blocksMissing: "non établi",
    blocksNoSweep: "Aucune position du convoi n'a pu servir de dernier véhicule, la colonne de réouverture est donc vide.",
