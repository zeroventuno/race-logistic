...
export const fr: Dictionary = {
  ...
  landing: {
    ...
    screens: {
      ...
      altApp: "Application chauffeur sur téléphone : rôle du véhicule, kilomètre actuel sur le parcours, état de l'envoi et les boutons d'alerte.",
    ...
    close: {
      ...
      trakr: "Même maison que TRAKR, public différent. L'athlète et l'entraîneur ont leur produit ; celui-ci est celui de ceux qui organisent — d'où son nom, son cycle de vente et ses règles propres.",
    ...
    footer: {
      ...
      languages: "L'application chauffeur parle",
      enter: "Se connecter",
      director: "Direction de course",
      signup: "Créer un compte",
      driver: "Chauffeur avec un code",
      credits: "un outil",
    },
