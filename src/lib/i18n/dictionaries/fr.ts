...
export const fr: Dictionary = {
  ...
  director: {
    ...
    reportHint: "PDF avec la fenêtre mesurée, les incidents et le convoi.",
    frozenTitle: "Rapport final",
    frozenLine: "Version {v} · {tamanho} kB · généré le {quando}",
    frozenHash: "Vérifiez le fichier reçu avec ce SHA-256 :",
    frozenAgain: "Générer une nouvelle version",
  ...
  auth: {
    ...
    recoverSubtitle: "Indiquez l'e-mail du compte. S'il existe, nous envoyons un lien pour définir un nouveau mot de passe.",
    recoverSubmit: "Envoyer le lien",
    recoverSent: "Si un compte existe pour {email}, le lien est en route. Il ne fonctionne qu'une fois et expire.",
    metaRecover: "Récupérer l'accès — Flamme Rouge",
    newPasswordTitle: "Nouveau mot de passe",
    newPasswordSubtitle: "Choisissez le mot de passe que vous utiliserez pour accéder au panneau.",
    newPasswordSubmit: "Enregistrer le mot de passe",
    passwordChanged: "Mot de passe modifié.",
    recoverExpired: "Ce lien n'est plus valable. Demandez-en un autre depuis « Mot de passe oublié ? ».",
    metaNewPassword: "Nouveau mot de passe — Flamme Rouge",
    ...
    confirmed: "C'est fait. Votre compte est actif et vous êtes déjà connecté.",
    confirmFailed: "Impossible de confirmer le compte. Le lien reçu par e-mail ne fonctionne qu'une fois et expire — recréez le compte avec la même adresse pour en recevoir un autre.",
    name: "Votre nom",
   ...
   */
  report: {
    kicker: "Rapport final de course",
    generated: "Document généré le {quando} à partir du registre de position du convoi.",
    windowSection: "La fenêtre de la course",
    maxObserved: "maximale observée",
    noLimit: "Aucune limite n'a été déclarée dans la fiche de la course.",
    over: "Au-delà de la limite de {min} min convenue avec l'autorité de circulation.",
    within: "Dans la limite de {min} min convenue avec l'autorité de circulation.",
    measuredIn: "Mesurée sur {pct} de la course par le passage des deux véhicules de référence au même point de la route. Le reste est estimé ou n'a pas pu être établi, et est signalé comme tel dans le document.",
    cannotMeasure: "N'a pas pu être mesurée",
    noDataAtAll: "Les données n'ont pas suffi pour établir la fenêtre de cette course.",
    summaryTitle: "1 · Synthèse",
    windowPair: "La fenêtre ouvreuse ↔ voiture-balai",
    authorized: "autorisée",
    notDeclared: "non déclarée",
    minLabel: "minimale",
    avgLabel: "moyenne",
    maxLabel: "maximale",
    onlyMeasured: "Minimale, moyenne et maximale ne retiennent que les instants réellement mesurés — {medidos} points sur {total} de la série. Les valeurs estimées n'entrent pas dans les statistiques que le document affirme.",
    rescue: "Secours",
    incidents: "incidents",
    medianArrive: "temps médian d'arrivée",
    unresolved: "sans clôture",
    convoy: "Convoi",
    vehicles: "véhicules",
    avgSignal: "couverture moyenne du signal",
    route: "parcours",
    period: "Période",
    periodLine: "Début {inicio} · clôture {fim}",
    timezone: " · fuseau {fuso}",
    tailWarning: "Attention : le convoi a cessé d'émettre {tempo} avant la clôture enregistrée. La période ci-dessus est celle déclarée dans le système, pas le temps pendant lequel il y a eu course sur la route.",
    chartTitle: "2 · La fenêtre, minute par minute",
    howToRead: "Comment lire",
    legMeasured: "Mesuré — {n} points. Écart d'horaire entre le passage des deux véhicules au même point de la route.",
    legDeduced: "Déduit — {n} points. Estimé d'après la vitesse, ou fondé sur une position déjà ancienne. Il n'a pas été observé.",
    legNoLine: "Sans trait — {n} points. Aucune position fiable des deux véhicules. Le vide est déclaré, pas caché.",
    legOvershoot: "Bande rouge — portion où la fenêtre a dépassé l'autorisé.",
    axes: "Axe vertical en minutes de fenêtre ; horizontal, l'heure locale de la course. La série est reconstruite à partir du registre de position enregistré sur le serveur.",
    chartCannot: "La fenêtre n'a pas pu être établie",
    blocksTitle: "3 · Points de blocage",
    blocksNone: "Aucun point de blocage n'a été enregistré pour cette course. Sans eux, le rapport ne peut pas indiquer combien de temps chaque carrefour est resté fermé.",
    colKm: "km",
    colPoint: "point",
    colClosed: "fermé",
    colReopened: "rouvert",
    colDuration: "durée",
    blocksLead: "« Fermé » est le passage de la voiture ouvreuse à ce kilomètre ; « rouvert », celui de la voiture de fermeture. La durée de chaque point est la fenêtre mesurée là. Ce qui suit la voiture de fermeture — motos d appui, mécaniciens, ambulances et voiture-balai — roule déjà avec la route ouverte à la circulation.",
    blocksMissing: "non établi",
    blocksNoSweep: "La voiture de fermeture n a pas transmis de position, la colonne de réouverture est donc vide.",
    incidentsTitle: "4 · Incidents",
    incidentsNone: "Aucun appel de secours n'a été enregistré durant cette course.",
    called: "appel {hora}",
    calledBy: "par {quem}",
    handledBy: "traité par {quem}",
    acknowledged: "pris en compte {hora}",
    dispatched: "envoyé {hora}",
    onScene: "sur place {hora}",
    closed: "clos {hora}",
    noEvents: "aucun événement enregistré après l'appel",
    toArrive: "jusqu'à l'arrivée : {valor}",
    toClose: "jusqu'à la clôture : {valor}",
    notRecorded: "non enregistré",
    notClosed: "non clos",
    convoyTitle: "5 · Le convoi",
    colVehicle: "véhicule",
    ...
    isSweep: " · fermeture",
    never: "jamais",
    outages: "Coupures de signal de plus de deux minutes",
  },
  ...
  blockpoints: {
    ...
    detectedNone: "Aucun nouveau carrefour trouvé sur OpenStreetMap pour ce parcours.",
    detectAgain: "Détecter à nouveau",
    empty: "Aucun point enregistré.",
    noRoute: "Enregistrez d'abord le parcours : les points sont placés par kilomètre le long de celui-ci.",
    add: "Ajouter un point",
    km: "km",
    name: "Nom",
    namePlaceholder: "Rond-point Via Roma × SP 422",
    unnamed: "sans nom",
    detectedTag: "détecté",
    active: "Compter dans le rapport",
    remove: "Supprimer",
    saving: "enregistrement",
    outOfRoute: "Hors du parcours, qui fait {km} km.",
    partial: "Balayé jusqu’au km {ate} sur {total}. Touchez à nouveau pour continuer.",
    swept: "Parcours entièrement balayé.",
  },
};
