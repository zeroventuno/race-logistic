...
export const it: Dictionary = {
  ...
  landing: {
    ...
    hero: {
      ...
      lead: "Ogni veicolo di assistenza sul percorso in tempo reale. Il divario tra apriscorsa e vettura di chiusura misurato come un intermedio di cronometraggio, non stimato. E i soccorsi scelti in base alla distanza che l'auto percorrerà davvero.",
    ...
    problem: {
      ...
      q1: "“Dov'è la vettura di chiusura?”",
    ...
    how: {
      ...
      s2Body: "Un codice di 6 caratteri per veicolo, con il ruolo di ciascuno: apriscorsa, chiusura, scopa, ambulanza, meccanico, moto, commissario. Il foglio esce pronto da stampare e consegnare al briefing.",
    ...
    screens: {
      ...
      altPanel: "Pannello della direzione gara: mappa del percorso con i veicoli di assistenza, divario tra apriscorsa e chiusura indicato come misurato, e la coda degli allarmi.",
      ...
      p2: "Divario tra apriscorsa e chiusura, indicato come misurato o proiettato.",
    ...
    close: {
      ...
      trakr: "Stessa casa di TRAKR, pubblico diverso. L'atleta e l'allenatore hanno il loro prodotto; questo è di chi organizza — e per questo ha nome, ciclo di vendita e regole proprie.",
    ...
    footer: {
      ...
      languages: "L'app dell'autista parla",
      enter: "Accedi",
      director: "Direzione gara",
      signup: "Crea account",
      driver: "Autista con codice",
      credits: "uno strumento",
    },

    meta: {
      title: "Flamme Rouge — direzione gara in tempo reale per il ciclismo su strada",
      description: "La posizione di ogni veicolo di assistenza misurata sulla strada, il divario tra apriscorsa e chiusura misurato come un intermedio, e allarmi che attivano il soccorso giusto per categoria. Il GPS è il telefono dell'autista.",
