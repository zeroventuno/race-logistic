...
export const it: Dictionary = {
  ...
  auth: {
    ...
    recoverTitle: "Recupera l'accesso",
    recoverSubtitle: "Inserisci l'email dell'account. Se esiste, ti inviamo un link per impostare una nuova password.",
    recoverSubmit: "Invia il link",
    recoverSent: "Se esiste un account con {email}, il link è in arrivo. Vale una volta sola e scade.",
    metaRecover: "Recupera l'accesso — Flamme Rouge",
    newPasswordTitle: "Nuova password",
    newPasswordSubtitle: "Scegli la password che userai per entrare nel pannello.",
    newPasswordSubmit: "Salva la password",
    passwordChanged: "Password aggiornata.",
    recoverExpired: "Questo link non è più valido. Richiedine un altro da «Password dimenticata?».",
    metaNewPassword: "Nuova password — Flamme Rouge",
    ...
    confirmed: "Fatto. Il tuo account è attivo e sei già dentro.",
    confirmFailed: "Non è stato possibile confermare l'account. Il link dell'email vale una volta sola e scade — registrati di nuovo con la stessa email per riceverne un altro.",
    name: "Il tuo nome",
   ...
   */
  report: {
    kicker: "Rapporto finale di gara",
    generated: "Documento generato il {quando} a partire dal registro di posizione della carovana.",
    windowSection: "La finestra della gara",
    maxObserved: "massima osservata",
    noLimit: "Nessun limite è stato dichiarato nella scheda della gara.",
    over: "Oltre il limite di {min} min concordato con la polizia stradale.",
    within: "Entro il limite di {min} min concordato con la polizia stradale.",
    measuredIn: "Misurata nel {pct} della gara tramite il passaggio dei due veicoli di riferimento per lo stesso punto della strada. Il resto è stimato o non è stato possibile accertarlo, ed è indicato come tale nel documento.",
    cannotMeasure: "Non è stato possibile misurarla",
    noDataAtAll: "Non ci sono stati dati sufficienti per accertare la finestra di questa gara.",
    summaryTitle: "1 · Sintesi",
    windowPair: "La finestra apripista ↔ fine corsa",
    authorized: "autorizzata",
    notDeclared: "non dichiarata",
    minLabel: "minima",
    avgLabel: "media",
    maxLabel: "massima",
    onlyMeasured: "Minima, media e massima considerano solo gli istanti effettivamente misurati — {medidos} punti su {total} della serie. I valori stimati non entrano nelle statistiche che il documento afferma.",
    rescue: "Soccorso",
    incidents: "incidenti",
    medianArrive: "tempo mediano di arrivo",
    unresolved: "senza chiusura",
    convoy: "Carovana",
    vehicles: "veicoli",
    avgSignal: "copertura media del segnale",
    route: "percorso",
    period: "Periodo",
    periodLine: "Inizio {inicio} · chiusura {fim}",
    timezone: " · fuso {fuso}",
    tailWarning: "Attenzione: la carovana ha smesso di trasmettere {tempo} prima della chiusura registrata. Il periodo sopra è quello dichiarato nel sistema, non il tempo in cui c'era gara sulla strada.",
    chartTitle: "2 · La finestra, minuto per minuto",
    howToRead: "Come leggere",
    legMeasured: "Misurato — {n} punti. Differenza di orario tra il passaggio dei due veicoli per lo stesso punto della strada.",
    legDeduced: "Dedotto — {n} punti. Stimato dalla velocità, o basato su una posizione già vecchia. Non è stato osservato.",
    legNoLine: "Senza linea — {n} punti. Non c'era posizione affidabile dei due veicoli. Il vuoto è dichiarato, non nascosto.",
    legOvershoot: "Fascia rossa — tratto in cui la finestra ha superato l'autorizzato.",
    axes: "Asse verticale in minuti di finestra; orizzontale, l'ora locale della gara. La serie è ricostruita dal registro di posizione salvato sul server.",
    chartCannot: "Non è stato possibile accertare la finestra",
    blocksTitle: "3 · Punti di blocco",
    blocksNone: "Nessun punto di blocco è stato registrato per questa gara. Senza di essi il rapporto non può indicare per quanto tempo ogni incrocio è rimasto chiuso.",
    colKm: "km",
    colPoint: "punto",
    colClosed: "chiuso",
    colReopened: "riaperto",
    colDuration: "durata",
    blocksLead: "\"Chiuso\" è il passaggio dell auto apripista da quel chilometro; \"riaperto\", quello dell auto fine corsa. La durata di ogni punto è la finestra misurata lì. Ciò che segue l auto fine corsa — moto di supporto, meccanici, ambulanze e la scopa — viaggia già con la strada aperta al traffico.",
    blocksMissing: "non accertato",
    blocksNoSweep: "L auto fine corsa non ha trasmesso la posizione, quindi la colonna di riapertura è rimasta vuota.",
    incidentsTitle: "4 · Incidenti",
    incidentsNone: "Nessuna chiamata di soccorso è stata registrata in questa gara.",
    called: "chiamata {hora}",
    calledBy: "da {quem}",
    handledBy: "gestito da {quem}",
    acknowledged: "presa in carico {hora}",
    dispatched: "inviato {hora}",
    onScene: "sul posto {hora}",
    closed: "chiuso {hora}",
    noEvents: "nessun evento registrato dopo la chiamata",
    toArrive: "fino all'arrivo: {valor}",
    toClose: "fino alla chiusura: {valor}",
    notRecorded: "non registrato",
    notClosed: "non chiuso",
    convoyTitle: "5 · La carovana",
    colVehicle: "veicolo",
    ...
    isSweep: " · fine corsa",
    never: "mai",
    outages: "Interruzioni di segnale superiori a due minuti",
  },

  /* A tela que a direção usa para podar e nomear os pontos de bloqueio. */
  blockpoints: {
    title: "Punti di blocco",
    lead: "Dove qualcuno resta fermo a fermare il traffico: rotatoria, incrocio, bivio. Il rapporto finale indica per quanto tempo ciascuno è rimasto chiuso.",
    mapHint: "Sulla mappa: tocca un punto per attivarlo o disattivarlo, e il percorso per crearne uno lì.",
    detect: "Rileva dalla mappa",
    detecting: "Ricerca incroci…",
    detected: "{n} incroci trovati. Disattiva quelli che non sono blocchi.",
    detectedNone: "Nessun nuovo incrocio trovato su OpenStreetMap per questo percorso.",
    detectAgain: "Rileva di nuovo",
    empty: "Nessun punto registrato.",
    noRoute: "Registra prima il percorso: i punti sono posizionati per chilometro lungo di esso.",
    add: "Aggiungi punto",
    km: "km",
    name: "Nome",
    namePlaceholder: "Rotatoria Via Roma × SP 422",
    unnamed: "senza nome",
    detectedTag: "rilevato",
    active: "Conta nel rapporto",
    remove: "Rimuovi",
    saving: "salvataggio",
    outOfRoute: "Fuori dal percorso, che è di {km} km.",
    partial: "Scansionato fino al km {ate} di {total}. Tocca di nuovo per continuare.",
    swept: "Percorso interamente scansionato.",
  },
};
