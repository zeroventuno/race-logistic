...
export const it: Dictionary = {
  ...
  report: {
    ...
    colDuration: "durata",
    blocksLead: "\"Chiuso\" è il passaggio dell'auto apripista da quel chilometro. \"Riaperto\" è il passaggio dell'ultimo veicolo della carovana — la scopa, non l'auto fine corsa: dietro l'auto fine corsa c'è ancora gara.",
    blocksMissing: "non accertato",
    blocksNoSweep: "Nessuna posizione della carovana ha potuto fare da ultimo veicolo, quindi la colonna di riapertura è rimasta vuota.",
