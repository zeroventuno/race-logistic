...
export const de: Dictionary = {
  ...
  landing: {
    ...
    close: {
      ...
      trakr: "Dasselbe Haus wie TRAKR, anderes Publikum. Athleten und Trainer haben ihr Produkt; dieses ist für die, die organisieren — deshalb hat es eigenen Namen, eigenen Verkaufszyklus und eigene Regeln.",
    ...
    footer: {
      ...
      languages: "Die Fahrer-App spricht",
      enter: "Anmelden",
      director: "Rennleitung",
      signup: "Konto erstellen",
      driver: "Fahrer mit Code",
