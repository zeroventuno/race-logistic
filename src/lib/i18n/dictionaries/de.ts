...
export const de: Dictionary = {
  ...
  report: {
    ...
    colDuration: "Dauer",
    blocksLead: "„Gesperrt\" ist die Durchfahrt des Führungsfahrzeugs an diesem Kilometer. „Freigegeben\" ist die Durchfahrt des letzten Konvoifahrzeugs — des Besenwagens, nicht des Schlussfahrzeugs: hinter dem Schlussfahrzeug ist noch Rennen.",
    blocksMissing: "nicht ermittelt",
    blocksNoSweep: "Keine Konvoiposition konnte als letztes Fahrzeug dienen, daher bleibt die Spalte zur Freigabe leer.",
