...
export const de: Dictionary = {
  ...
  director: {
    ...
    frozenTitle: "Abschlussbericht",
    frozenLine: "Version {v} · {tamanho} kB · erstellt am {quando}",
    frozenHash: "Prüfen Sie die erhaltene Datei mit diesem SHA-256:",
    frozenAgain: "Neue Version erstellen",
