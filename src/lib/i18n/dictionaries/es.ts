...
export const es: Dictionary = {
  ...
  report: {
    ...
    blocksLead: "«Cerró» es el paso del coche de apertura por ese kilómetro. «Reabrió» es el paso del último vehículo del convoy — la escoba, no el coche de cierre: detrás del coche de cierre todavía hay carrera.",
    blocksMissing: "no determinado",
    blocksNoSweep: "Ninguna posición del convoy pudo servir de último vehículo, así que la columna de reapertura quedó vacía.",
