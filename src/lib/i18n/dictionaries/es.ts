...
export const es: Dictionary = {
  ...
  landing: {
    ...
    screens: {
      ...
      altApp: "App del conductor en el móvil: papel del vehículo, kilómetro actual en el recorrido, estado del envío y los botones de alerta.",
    ...
    close: {
      ...
      trakr: "Misma casa que TRAKR, público distinto. El atleta y el entrenador tienen su producto; este es el de quien organiza — y por eso tiene nombre, ciclo de venta y reglas propias.",
    ...
    footer: {
      ...
      languages: "La app del conductor habla",
      enter: "Entrar",
      director: "Dirección de carrera",
      signup: "Crear cuenta",
      driver: "Conductor con código",
