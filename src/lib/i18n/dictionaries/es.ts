...
export const es: Dictionary = {
  ...
  director: {
    ...
    frozenTitle: "Informe final",
    frozenLine: "Versión {v} · {tamanho} kB · generado el {quando}",
    frozenHash: "Verifique el archivo recibido con este SHA-256:",
    frozenAgain: "Generar versión nueva",
   ...
   */
  report: {
    kicker: "Informe final de carrera",
    generated: "Documento generado el {quando} a partir del registro de posición del convoy.",
    windowSection: "La ventana de la carrera",
    maxObserved: "máxima observada",
    noLimit: "No se declaró ningún límite en la ficha de la carrera.",
    over: "Por encima del límite de {min} min acordado con la autoridad de tráfico.",
    within: "Dentro del límite de {min} min acordado con la autoridad de tráfico.",
    measuredIn: "Medida en el {pct} de la carrera por el paso de los dos vehículos de referencia por el mismo punto de la carretera. El resto es estimado o no pudo determinarse, y está señalado como tal en el documento.",
    cannotMeasure: "No pudo medirse",
    noDataAtAll: "No hubo datos suficientes para determinar la ventana de esta carrera.",
    summaryTitle: "1 · Resumen",
    windowPair: "La ventana apertura ↔ cierre",
    authorized: "autorizada",
    notDeclared: "no declarada",
    minLabel: "mínima",
    avgLabel: "media",
    maxLabel: "máxima",
    onlyMeasured: "Mínima, media y máxima consideran solo los instantes realmente medidos — {medidos} de {total} puntos de la serie. Los valores estimados no entran en estadísticas que el documento afirma.",
    rescue: "Auxilio",
    incidents: "incidentes",
    medianArrive: "tiempo mediano hasta llegar",
    unresolved: "sin cierre",
    convoy: "Convoy",
    vehicles: "vehículos",
    avgSignal: "cobertura media de señal",
    route: "recorrido",
    period: "Período",
    periodLine: "Inicio {inicio} · cierre {fim}",
    timezone: " · huso {fuso}",
    tailWarning: "Atención: el convoy dejó de transmitir {tempo} antes del cierre registrado. El período de arriba es el declarado en el sistema, no el tiempo en que hubo carrera en la carretera.",
    chartTitle: "2 · La ventana, minuto a minuto",
    howToRead: "Cómo leer",
    legMeasured: "Medido — {n} puntos. Diferencia de horario entre el paso de los dos vehículos por el mismo punto de la carretera.",
    legDeduced: "Deducido — {n} puntos. Estimado por la velocidad, o apoyado en una posición ya antigua. No fue observado.",
    legNoLine: "Sin línea — {n} puntos. No había posición fiable de los dos vehículos. El vacío se declara, no se esconde.",
    legOvershoot: "Franja roja — tramo en que la ventana superó lo autorizado.",
    axes: "Eje vertical en minutos de ventana; horizontal, la hora local de la carrera. La serie se reconstruye del registro de posición guardado en el servidor.",
    chartCannot: "La ventana no pudo determinarse",
    blocksTitle: "3 · Puntos de bloqueo",
    blocksNone: "No se registró ningún punto de bloqueo para esta carrera. Sin ellos el informe no puede indicar cuánto tiempo estuvo cerrado cada cruce.",
    colKm: "km",
    colPoint: "punto",
    colClosed: "cerró",
    colReopened: "reabrió",
    colDuration: "duración",
    blocksLead: "«Cerró» es el paso del coche de apertura por ese kilómetro; «reabrió», el del coche de cierre. La duración de cada punto es la ventana medida allí. Lo que va detrás del coche de cierre — motos de apoyo, mecánicos, ambulancias y la escoba — ya circula con la carretera abierta al tráfico.",
    blocksMissing: "no determinado",
    blocksNoSweep: "El coche de cierre no transmitió posición, así que la columna de reapertura quedó vacía.",
    incidentsTitle: "4 · Incidentes",
    incidentsNone: "No se registró ninguna llamada de auxilio en esta carrera.",
    called: "llamada {hora}",
    calledBy: "por {quem}",
    handledBy: "atendido por {quem}",
    acknowledged: "reconocido {hora}",
    dispatched: "despachado {hora}",
    onScene: "en el lugar {hora}",
    closed: "cerrado {hora}",
    noEvents: "sin eventos registrados tras la llamada",
    toArrive: "hasta llegar: {valor}",
    toClose: "hasta cerrar: {valor}",
    notRecorded: "no registrado",
    notClosed: "no cerrado",
    convoyTitle: "5 · El convoy",
    colVehicle: "vehículo",
    colDriver: "conductor",
    colPlate: "matrícula",
    colSignal: "señal",
    ...
    isSweep: " · cierre",
    never: "nunca",
    outages: "Interrupciones de señal de más de dos minutos",
  },
  ...
  blockpoints: {
    ...
    detectedNone: "No se encontraron cruces nuevos en OpenStreetMap para este recorrido.",
    detectAgain: "Detectar de nuevo",
    empty: "Ningún punto registrado todavía.",
    noRoute: "Registre antes el recorrido: los puntos se colocan por kilómetro a lo largo de él.",
    add: "Añadir punto",
    km: "km",
    name: "Nombre",
    namePlaceholder: "Rotonda Via Roma × SP 422",
    unnamed: "sin nombre",
    detectedTag: "detectado",
    active: "Contar en el informe",
    remove: "Quitar",
    saving: "guardando",
    outOfRoute: "Fuera del recorrido, que tiene {km} km.",
    partial: "Barrido hasta el km {ate} de {total}. Toque otra vez para continuar.",
    swept: "Recorrido barrido por completo.",
  },
};
