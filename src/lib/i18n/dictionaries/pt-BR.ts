...
export const ptBR = {
  ...
  report: {
    ...
    colReopened: "reabriu",
    colDuration: "duração",
    blocksLead: "\"Fechou\" é a passagem do carro de abertura por aquele quilômetro. \"Reabriu\" é a passagem do último veículo do comboio — a vassoura, não o fechamento: atrás do carro de fechamento ainda vem prova.",
    blocksMissing: "não apurado",
    blocksNoSweep: "Nenhuma posição do comboio pôde ser usada como último veículo, então a coluna de reabertura ficou vazia.",
