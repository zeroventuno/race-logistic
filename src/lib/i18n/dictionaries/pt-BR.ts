...
export const ptBR = {
  ...
  alerts: {
    ...
    why: {
      target: "{position}",
      eta: "~{minutes} min",
      uncertainAnchor: "POSIÇÃO INCERTA: a âncora no percurso foi escolhida por desempate — confirme por rádio antes de contar com esta distância",
      ahead: "{distance} à frente do alerta (precisa retornar)",
      behind: "{distance} atrás do alerta, no sentido da prova",
      straightOnly: "{distance} em linha reta — sem posição na rota, a distância pela estrada é maior",
      speedMeasured: "velocidade média medida {speed} km/h",
      speedNominal: "tempo estimado por velocidade nominal ({speed} km/h): sem deslocamento recente medido",
      lastSeen: "última posição há {seconds} s",
      offSpecialty: "{role} não é a especialidade para {category} — sugerido por proximidade",
      noOrigin: "Sem posição de origem do alerta: nenhuma sugestão calculável.",
      noneSuggested: "Nenhum apoio sugerido.",
      noneDispatchable: "Nenhum veículo despachável cadastrado nesta prova.",
      count: "{count} sugestão(ões) para {category}.",
      uncertainCount: "{count} candidato(s) com âncora ambígua — distância não confiável.",
      ignoredBusy: "{count} já acionado(s) para outro alerta.",
      ignoredNoSignal: "{count} ignorado(s) por sinal perdido.",
      ignoredRole: "{count} não despachável(is).",
      escalated: "ESCALONADO: nenhum veículo da especialidade disponível; acionado {role}.",
      allStraight: "Todas em linha reta: sem posição na rota para comparar.",
      takenMeanwhile: "Todos os candidatos foram tomados por outros alertas durante o acionamento.",
      manual: "{position} — acionado manualmente pela direção.",
    },
    dispatch: {
  ...
  driver: {
    ...
    api: {
      badJson: "Corpo da requisição não é JSON válido.",
      pingsNotArray: "Campo pings precisa ser um array.",
      bodyTooLarge: "Corpo de {bytes} bytes acima do limite de {limit}.",
      bodyOverLimit: "Corpo acima do limite de {limit} bytes.",
      noBody: "Requisição sem corpo.",
      bodyReadFailed: "Falha ao ler o corpo da requisição.",
      bodyNotObject: "Corpo da requisição precisa ser um objeto JSON.",
      batchTooLarge: "Lote com {count} pings excede o máximo de {max}. Divida o envio.",
      alertSaveFailed: "Não foi possível registrar o alerta. Mantenha na fila e avise pelo rádio.",
      confirmKindInvalid: "Tipo de confirmação inválido: {kind}.",
      alertNotFound: "Alerta não encontrado nesta prova.",
      confirmFailed: "Falha ao registrar a confirmação. Tente de novo.",
      actionInvalid: "Ação inválida: {action}.",
      bindRateLimited: "Muitas tentativas seguidas. Aguarde {minutes} min e confira o código com a direção.",
      bindLookupFailed: "Falha ao consultar o código. Tente de novo.",
      bindRaceFailed: "Falha ao carregar a prova deste código.",
      bindFailed: "Não foi possível concluir o vínculo. Tente de novo em alguns segundos.",
      bindUnknownCode: "Código não reconhecido. Confira os 6 caracteres com a direção da prova.",
      takenOver: "outro aparelho assumiu esta posição",
      positionsFailed: "Falha ao carregar as posições da prova.",
      notBound: "Este aparelho não está vinculado a nenhuma posição.",
      sessionCheckFailed: "Falha ao validar a sessão. O aparelho continua vinculado; tentando de novo.",
      sessionUnknown: "Vínculo não reconhecido pelo servidor. Peça um código novo à direção.",
      sessionRevokedWhy: "Vínculo encerrado pela direção: {reason}",
      sessionRevoked: "Este vínculo foi encerrado pela direção. Peça um código novo.",
      positionGone: "A posição vinculada a este aparelho não existe mais.",
      pingBadId: "clientPingId não é um UUID válido.",
      pingNoCoord: "Coordenada ausente ou não numérica.",
      pingOutOfRange: "Coordenada fora do intervalo geográfico válido.",
      pingNullIsland: "Coordenada (0, 0) — leitura inválida do GPS.",
      pingInaccurate: "Precisão de {accuracy} m acima do limite de {limit} m.",
      pingBadDate: "recordedAt não é uma data ISO 8601 válida.",
      pingFuture: "recordedAt está {minutes} min no futuro — relógio do aparelho fora de hora.",
    },
  ...
  route: {
    ...
    pointsMissing: "A lista de pontos do percurso não veio.",
    pointsTooMany: "O percurso tem {count} pontos, acima do limite de {limit}. Recorte o arquivo para o trecho da prova antes de enviar.",
    pointMalformed: "O ponto {index} está malformado.",
    pointBadLat: "O ponto {index} tem latitude inválida ({value}).",
    pointBadLng: "O ponto {index} tem longitude inválida ({value}).",
    etaUnknown: "tempo estimado indisponível",
    uploadTooLarge:
  ...
  live: {
    warnStates: "Falha ao ler as posições ao vivo dos veículos.",
    warnSessions: "Falha ao ler os vínculos de aparelho.",
    warnAlerts: "Falha ao ler os alertas: {detail}",
    warnPositions: "Falha ao ler as posições: {detail}",
    warnGeometry: "Geometria do percurso indisponível: {detail} O trecho ocupado não será desenhado.",
  ...
  auth: {
    ...
    recoverSubtitle: "Informe o e-mail da conta. Se ela existir, mandamos um link para você definir uma senha nova.",
    recoverSubmit: "Enviar link",
    recoverSent: "Se existe uma conta com {email}, o link está a caminho. Ele vale uma vez e expira.",
    metaRecover: "Recuperar acesso — Flamme Rouge",
    newPasswordTitle: "Nova senha",
    newPasswordSubtitle: "Escolha a senha que você vai usar para entrar no painel.",
    newPasswordSubmit: "Salvar senha",
    passwordChanged: "Senha alterada.",
    recoverExpired: "Este link não vale mais. Peça outro em «Esqueci minha senha».",
    metaNewPassword: "Nova senha — Flamme Rouge",
    ...
    confirmed: "Pronto. Sua conta está ativa e você já está dentro.",
    confirmFailed: "Não deu para confirmar a conta. O link do e-mail vale uma vez só e expira depois de um tempo — crie a conta de novo com o mesmo e-mail para receber outro.",
    name: "Seu nome",
  ...
  landing: {
    ...
    measures: {
      ...
      diagramAria: "Esquema de um percurso de ida e volta. O ponto do acidente fica na perna de ida; a moto está na perna de volta, a 50 metros em linha reta mas a 37,3 quilômetros pela estrada. A ambulância está 1,5 quilômetro atrás do acidente, na mesma perna e no mesmo sentido.",
      diagramMoto: "**0,05 km** em linha reta entre a moto e o acidente. É este o número que um sistema de proximidade geométrica usa — e por ele a moto seria a escolhida.",
      diagramRoute: "**37,3 km** pela estrada, no mesmo instante: a moto está na perna de volta e teria que refazer o retorno inteiro contra o fluxo da prova.",
      diagramAmb: "**1,5 km** atrás, na mesma perna e no mesmo sentido: a ambulância, que foi quem o sistema acionou.",
      diagramNote: "Esquema fora de escala. Números medidos num percurso real de teste.",
    ...
    contact: {
      eyebrow: "Contato",
      title: "Fale com quem faz.",
      body: "Conte que prova você organiza e o que precisa resolver. Quem responde é a pessoa que escreveu o sistema, no seu idioma.",
      name: "Seu nome",
      email: "E-mail",
      organization: "Organização",
      message: "Mensagem",
      messagePlaceholder: "Que prova você organiza, quantos veículos de apoio, e quando é.",
      send: "Enviar",
      sending: "Enviando…",
      sentTitle: "Recebido.",
      sentBody: "Respondo no endereço que você deixou, e no idioma em que você escreveu.",
      orWrite: "Ou escreva direto para",
      failed: "Não deu para enviar agora. Sua mensagem continua aí — copie e mande para",
      tooMany: "Muitas mensagens em pouco tempo deste mesmo lugar. Espere um pouco, ou escreva para",
      nameRequired: "Diga seu nome — é como vou começar a resposta.",
      emailRequired: "Preciso de um e-mail para responder.",
      emailInvalid: "Esse e-mail não parece válido. Confira se falta o @ ou o domínio.",
      messageRequired: "Escreva o que você precisa, mesmo que em uma linha.",
   ...
   */
  report: {
    kicker: "Relatório final de prova",
    generated: "Documento gerado em {quando} a partir do registro de posição do comboio.",
    windowSection: "A janela da prova",
    maxObserved: "máxima observada",
    noLimit: "Nenhum limite foi declarado no cadastro da prova.",
    over: "Acima do limite de {min} min combinado com a autoridade de trânsito.",
    within: "Dentro do limite de {min} min combinado com a autoridade de trânsito.",
    measuredIn: "Medida em {pct} da prova pela passagem dos dois veículos de referência pelo mesmo ponto da estrada. O restante é estimado ou não pôde ser apurado, e está identificado como tal ao longo do documento.",
    cannotMeasure: "Não pôde ser medida",
    noDataAtAll: "Não houve dado suficiente para apurar a janela desta prova.",
    summaryTitle: "1 · Sumário",
    windowPair: "A janela abertura ↔ fechamento",
    authorized: "autorizada",
    notDeclared: "não declarada",
    minLabel: "mínima",
    avgLabel: "média",
    maxLabel: "máxima",
    onlyMeasured: "Mínima, média e máxima consideram apenas os instantes efetivamente medidos — {medidos} de {total} pontos da série. Valores estimados não entram em estatística que o documento afirma.",
    rescue: "Socorro",
    incidents: "incidentes",
    medianArrive: "tempo mediano até chegar",
    unresolved: "sem encerramento",
    convoy: "Comboio",
    vehicles: "veículos",
    avgSignal: "cobertura média de sinal",
    route: "percurso",
    period: "Período",
    periodLine: "Início {inicio} · encerramento {fim}",
    timezone: " · fuso {fuso}",
    tailWarning: "Atenção: o comboio parou de transmitir {tempo} antes do encerramento registrado. O período acima é o declarado no sistema, não o tempo em que houve prova na estrada.",
    chartTitle: "2 · A janela, minuto a minuto",
    howToRead: "Como ler",
    legMeasured: "Medido — {n} pontos. Diferença de horário entre a passagem dos dois veículos pelo mesmo ponto da estrada.",
    legDeduced: "Deduzido — {n} pontos. Estimado pela velocidade, ou apoiado em posição que já estava velha. Não foi observado.",
    legNoLine: "Sem linha — {n} pontos. Não havia posição confiável dos dois veículos. O vazio é declarado, não escondido.",
    legOvershoot: "Faixa vermelha — trecho em que a janela passou do autorizado.",
    axes: "Eixo vertical em minutos de janela; horizontal, a hora local da prova. A série é reconstruída do registro de posição gravado no servidor.",
    chartCannot: "A janela não pôde ser apurada",
    blocksTitle: "3 · Pontos de bloqueio",
    blocksNone: "Nenhum ponto de bloqueio foi cadastrado para esta prova. Sem eles, o relatório não tem como informar por quanto tempo cada cruzamento ficou fechado.",
    colKm: "km",
    colPoint: "ponto",
    colClosed: "fechou",
    colReopened: "reabriu",
    colDuration: "duração",
    blocksLead: "\"Fechou\" é a passagem do carro de abertura por aquele quilômetro; \"reabriu\", a do carro de fechamento. A duração de cada ponto é a janela medida ali. O que vem atrás do fechamento — motos de apoio, mecânicos, ambulâncias e a vassoura — já anda com a rua aberta ao trânsito.",
    blocksMissing: "não apurado",
    blocksNoSweep: "O carro de fechamento não transmitiu posição, então a coluna de reabertura ficou vazia.",
    incidentsTitle: "4 · Incidentes",
    incidentsNone: "Nenhum acionamento de socorro foi registrado nesta prova.",
    called: "chamado {hora}",
    calledBy: "por {quem}",
    handledBy: "atendido por {quem}",
    acknowledged: "reconhecido {hora}",
    dispatched: "despachado {hora}",
    onScene: "no local {hora}",
    closed: "encerrado {hora}",
    noEvents: "sem eventos registrados após o chamado",
    toArrive: "até chegar: {valor}",
    toClose: "até encerrar: {valor}",
    notRecorded: "não registrado",
    notClosed: "não encerrado",
    convoyTitle: "5 · O comboio",
    colVehicle: "veículo",
    colDriver: "motorista",
    colPlate: "placa",
    colSignal: "sinal",
    ...
    isSweep: " · fechamento",
    never: "nunca",
    outages: "Interrupções de sinal acima de dois minutos",
  },
  ...
  blockpoints: {
    ...
    detectedNone: "Nenhum cruzamento novo foi encontrado no OpenStreetMap para este percurso.",
    detectAgain: "Detectar de novo",
    empty: "Nenhum ponto cadastrado ainda.",
    noRoute: "Cadastre o percurso antes: os pontos são posicionados por quilômetro ao longo dele.",
    add: "Acrescentar ponto",
    km: "km",
    name: "Nome",
    namePlaceholder: "Rotatória Via Roma × SP 422",
    unnamed: "sem nome",
    detectedTag: "detectado",
    active: "Contar no relatório",
    remove: "Remover",
    saving: "salvando",
    outOfRoute: "Fora do percurso, que tem {km} km.",
    partial: "Varrido até o km {ate} de {total}. Toque de novo para continuar.",
    swept: "Percurso inteiro varrido.",
  },
} as const;
